...
export abstract class BaseAppService implements AppService {
  ...
  async loadSettings(): Promise<SystemSettings> {
    ...
    try {
      ...
      // Apply defaults but ensure openBookInNewWindow is set to false for existing users
      settings = { ...DEFAULT_SYSTEM_SETTINGS, ...settings };
      
      // Force openBookInNewWindow to false for all users (this is the new default behavior)
      settings.openBookInNewWindow = false;
      ...
      settings = {
        ...
        openBookInNewWindow: false, // Ensure this is explicitly set for new installations
