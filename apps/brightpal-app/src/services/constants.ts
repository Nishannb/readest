...
export const LOCAL_BOOKS_SUBDIR = 'BrightPal/Books';
export const CLOUD_BOOKS_SUBDIR = 'BrightPal/Books';
...
export const DOWNLOAD_BRIGHTPAL_URL = 'https://brightpal.com?utm_source=brightpal_web';

export const BRIGHTPAL_WEB_BASE_URL = 'https://web.brightpal.com';
export const BRIGHTPAL_NODE_BASE_URL = 'https://node.brightpal.com';

const LATEST_DOWNLOAD_BASE_URL = 'https://mero-domain.com/updates';

export const BRIGHTPAL_UPDATER_FILE = `${LATEST_DOWNLOAD_BASE_URL}/latest.json`;

export const BRIGHTPAL_CHANGELOG_FILE = `${LATEST_DOWNLOAD_BASE_URL}/release-notes.json`;
