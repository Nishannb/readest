...
const title = 'BrightPal AI — Where You Read, Digest and Get Insight';
const description =
  'Discover BrightPal AI, the ultimate online ebook reader for immersive and organized reading. ' +
  ...
  return (
    <html>
      <head>
        ...
        <meta name='apple-mobile-web-app-title' content='BrightPal AI' />
