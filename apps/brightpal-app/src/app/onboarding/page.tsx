        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Nuclear Reset Button (Dev Only) */}
              {/* {process.env.NODE_ENV === 'development' && (
                <button
                  onClick={() => {
                    if (confirm('🧨 NUCLEAR RESET 🧨\n\nThis will clear ALL data and restart the app.\nAre you sure?')) {
                      usePaymentStore.getState().nuclearReset();
                    }
                  }}
                  className="px-3 py-1 text-sm text-red-800 bg-red-100 hover:bg-red-200 rounded-md transition-colors font-semibold"
                  title="Nuclear reset - clear everything (dev only)"
                >
                  🧨 NUCLEAR
                </button>
              )} */}
