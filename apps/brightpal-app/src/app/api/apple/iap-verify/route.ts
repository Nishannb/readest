...
const PRODUCT_MAP: Record<string, string> = {
  'com.nishan.brightpal.monthly.plus': 'Plus',
  'com.nishan.brightpal.yearly.plus': 'Plus',
  'com.nishan.brightpal.monthly.pro': 'Pro',
  'com.nishan.brightpal.yearly.pro': 'Pro',
};
...
export async function POST(request: Request) {
  ...
  const user = { id: 'local-user-id', email: 'user@brightpal.local' } as any;
