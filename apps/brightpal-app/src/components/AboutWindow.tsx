      ...
      <div className='about-content flex h-full flex-col items-center justify-center'>
        <div className='flex flex-col items-center gap-2 px-8'>
          <div className='mb-2 mt-8'>
            <Image src='/favicon.ico' alt='App Logo' className='h-20 w-20' width={64} height={64} />
          </div>
          <div className='flex select-text flex-col items-center'>
            <h2 className='mb-2 text-2xl font-bold'>BrightPal AI</h2>
        ...
        <div className='flex flex-col items-center px-4 text-center' dir='ltr'>
          <p className='text-neutral-content text-sm'>
            © {new Date().getFullYear()} Nishan Baral. All rights reserved.
          </p>

          <p className='text-neutral-content mt-2 text-xs'>
            This software is built on top of the open source Readest project{' '}
          </p>
          <p className='text-neutral-content my-2 text-xs'>
            Source code is available at{' '}
            <Link href='https://github.com/Nishannb/readest' className='text-blue-500 underline'>
              GitHub
            </Link>
            .
          </p>
